    ...
    <div className="lost-card-status-page">
      ...
      {card && (
        <div className="card-status-card">
          ...
          <div className="card-details">
            ...
            {card.pickupCode && (
              <div className="detail-row">
                ...
                <span className="detail-value pickup-code">{card.pickupCode}</span>
              </div>
            )}
          ...
          {(card.status === 'email_sent' || card.status === 'notified_owner') && card.boxId && card.pickupCode && (
            <div className="pickup-instructions">
              <h3>📦 Pickup Instructions</h3>
              <p>Go to <strong>{card.boxId}</strong> and enter pickup code: <strong style={{ fontFamily: 'monospace', fontSize: '1.2em' }}>{card.pickupCode}</strong></p>
            </div>
          )}
